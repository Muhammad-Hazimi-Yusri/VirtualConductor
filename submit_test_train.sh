#!/bin/bash
#SBATCH --job-name=train   #test_unseen
...
#SBATCH --output=test_unseen_%j.out # Output file (%j = job ID)
#SBATCH --error=test_unseen_%j.err  # Error file
...
echo "Starting M2SNet_train.py..."
python M2SNet_train.py --dataset_dir dataset
